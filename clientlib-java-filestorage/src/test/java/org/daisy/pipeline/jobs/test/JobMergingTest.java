...
public class JobMergingTest {
	...
	public void testTemplates() throws URISyntaxException { // TODO
		...
		DP2PersistentClientImpl template1 = DP2PersistentClientImpl.loadJob("job1", jobStorage);
		DP2PersistentClientImpl template2 = DP2PersistentClientImpl.loadJob("job2", jobStorage);
